...
{
    public class ListarProdutoHttp : IListarHttp<ProdutoDTO>
    {
        private readonly IHttpRepository<Produto, ProdutoDTO> repository;
        public ListarProdutoHttp(IHttpRepository<Produto, ProdutoDTO> repository)
        {
            this.repository = repository;
        }
        public Task<IEnumerable<ProdutoDTO>> ExecutarListagem()
        {
