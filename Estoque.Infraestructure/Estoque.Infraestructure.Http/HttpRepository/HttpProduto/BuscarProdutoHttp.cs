...
{
    public class BuscarProdutoHttp : IBuscarHttp<ProdutoDTO>
    {
        private readonly IHttpRepository<Produto, ProdutoDTO> repository;
        public BuscarProdutoHttp(IHttpRepository<Produto, ProdutoDTO> repository)
        {
            this.repository = repository;
        }
        public Task<ProdutoDTO> ExecutarBusca(string id)
        {
