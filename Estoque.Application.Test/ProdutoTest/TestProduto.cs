...
namespace Estoque.Application.Test.ProdutoTest
{
    public class TestEntradaProduto
    {
        ...
        [Test]
        [TestCase("b3e1c5d2-7f4b-4a8e-8d6f-9a5f8e7b0c2a", "520d8ea5-17d0-4c80-be68-6ef17d907534", "Notebook Asus", "UN", 3, 3000.00, 3500.00, 3200.00)]
        [TestCase("b3e1c5d2-7f4b-4a8e-8d6f-9a5f8e7b0c2a", "520d8ea5-17d0-4c80-be68-6ef17d907534", "Samsung S24", "UN", 3, 3000.00, 3500.00, 3200.00)]
            ...
            string unidade, int quantidade, decimal preco1, decimal preco2, decimal preco3)
        {
            ...
            {
                //Cadastrar
                Produto = new Produto(Guid.Parse(idUsuario), Guid.Parse(idCategoria), descricao, unidade, quantidade, preco1, preco2, preco3);
        ...
        [TestCase("b3e1c5d2-7f4b-4a8e-8d6f-9a5f8e7b0c2a", "520d8ea5-17d0-4c80-be68-6ef17d907534", "Samsung S90", "UN", 
            10, 7000.00, 7500.00, 7200.00, "f4c9e2b7-8d3a-4e6f-9b2d-7a1c5e0f3b8d")]
        public async Task AtualizarNaBase(string idUsuario, string idCategoria, string descricao,
            string unidade, int quantidade, decimal preco1, decimal preco2, decimal preco3, string idProdutoAtual)
        {
            //Arrange
            bool resultado;
            Exception exception = null;
