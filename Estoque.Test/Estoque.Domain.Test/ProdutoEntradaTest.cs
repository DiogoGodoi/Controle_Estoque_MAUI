...
namespace Estoque.Domain.Test
{
    ...
    public class ProdutoEntradaTest
    {
        ...
        [Test]
        [TestCase("2025-03-19 10:00:00", 150, 2, "510d4ea5-17d0-4c80-be68-6ef17d907534", "b3e1c5d2-7f4b-4a8e-8d6f-9a5f8e7b0c2a", 
            "520d8ea5-17d0-4c80-be68-6ef17d907534", "Iphone 13", "un", 5, 5000.00, 5500.00, 7000.00)]
        public void TestarProdutoEntrada(DateTime dataEntrada, int quantidadeEntrada, int estoqueMin, string idLocalEstoque, 
            string idUsuario, string idCategoria, string descricao, string unidade, int quantidadeProduto, decimal preco1, decimal preco2, decimal preco3)
        {
            ...
            try
            {
                produto = new Produto(Guid.Parse(idUsuario), Guid.Parse(idCategoria), Guid.Parse(idLocalEstoque), descricao, unidade, 
                    quantidadeProduto, preco1, preco2, preco3, estoqueMin);
